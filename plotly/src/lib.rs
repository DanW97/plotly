...
pub use traces::{
    Bar, BoxPlot, Candlestick, Contour, Cone, HeatMap, Histogram, Ohlc, Sankey, Scatter, Scatter3D,
    ScatterPolar, Surface,
};
// Also provide easy access to modules which contain additional trace-specific types
pub use traces::{box_plot, contour, histogram, sankey, surface, heat_map, cone};
